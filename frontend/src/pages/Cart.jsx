  ...
  return (
    <div className="customer-app min-h-screen pb-32">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="space-y-4 mb-6">
          {cart.map((item) => (
            <div
              ...
              className="bg-white rounded-xl shadow-lg shadow-orange-500/10 p-4 flex gap-4"
            >
              <img
                src={item.image_url}
                alt={item.name}
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <span className="text-lg font-bold text-slate-800 w-8 text-center">{item.quantity}</span>
                  <button
        ...
        <div className="bg-white rounded-xl shadow-lg shadow-orange-500/10 p-4 mb-6">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 border border-orange-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
            rows={3}
          />
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white shadow-2xl p-4">
        <div className="max-w-4xl mx-auto">
          <button
            ...
            onClick={placeOrder}
            disabled={loading}
            className="w-full py-4 bg-orange-500 text-white rounded-full font-bold text-lg hover:bg-orange-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed btn-press"
          >
