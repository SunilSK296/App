...
const WS_URL = BACKEND_URL.replace("http", "ws") + "/api/ws/kitchen";
              ...
              return (
                ...
                <div
                  ...
                  className={`rounded-xl border-l-4 ${
                    ...
                    isLate && order.status !== "served"
                      ? "animate-pulse"
                      : ""
                  } bg-slate-800 shadow-xl p-4 transition-all hover:scale-105`}
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <Clock
                          size={16}
                          className={isLate ? "text-red-400" : "text-gray-400"}
                        />
                  ...
                  <div className="space-y-2">
                    ...
                    {order.status === "received" && (
                      ...
                      <button
                        ...
                        className="w-full py-3 bg-yellow-500 text-white rounded-lg font-bold hover:bg-yellow-600"
                      >
