...
const AdminTables = () => {
  ...
  const handleDeleteTable = async (tableNumber) => {
    ...
    try {
      ...
      await axios.delete(`${API}/tables/${tableNumber}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
            ...
            >
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors mb-2"
                >
                  <Download size={20} />
                  Download QR Code
                </button>
        ...
        {tables.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-500 text-xl">
              No tables created yet. Create your first table above!
            </p>
          </div>
        )}
